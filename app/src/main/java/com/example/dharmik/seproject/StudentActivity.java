...
public class StudentActivity extends AppCompatActivity
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //set USerPhoto
        ImageView UserPhoto = headerView.findViewById(R.id.header_pic_student);
        UserPhoto.setImageURI(uPhoto);

        //set UserName
        TextView userName = headerView.findViewById(R.id.header_text_student_name);
        userName.setText(uName);

        //set UserEmail
        TextView userEmail = headerView.findViewById(R.id.header_email_student);
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (id == R.id.action_settings_student) {
            return true;
        }
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        if (id == R.id.nav_student_camera) {
            // Handle the camera action
        } else if (id == R.id.nav_student_gallery) {

        } else if (id == R.id.nav_student_slideshow) {

        } else if (id == R.id.nav_student_manage) {

        } else if (id == R.id.nav_student_share) {
